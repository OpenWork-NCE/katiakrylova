...
/**
 * Globals added for page backgrounds + Links hub:
 * - journal (page list background)
 * - links (background + collaborators list)
 */
export async function up({ db }: MigrateUpArgs): Promise<void> {
  ...
  DO $$ BEGIN
    ALTER TABLE "journal" ADD CONSTRAINT "journal_photo_id_media_id_fk"
  ...
  CREATE INDEX IF NOT EXISTS "journal_photo_idx" ON "journal" USING btree ("photo_id");
